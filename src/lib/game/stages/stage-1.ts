...
export const stage1: StageConfig = {
  ...
  spawns: [
    { x: 30,  type: 'enemy-soldier', count: 2, formation: 'line' },
    { x: 50,  type: 'enemy-soldier', count: 1, formation: 'line' },
    { x: 70,  type: 'enemy-turret',  count: 1, formation: 'line' },
    { x: 90,  type: 'enemy-soldier', count: 2, formation: 'spread' },
    { x: 110, type: 'enemy-soldier', count: 1, formation: 'line' },
    { x: 130, type: 'enemy-drone',   count: 2, formation: 'staggered', altitude: 6 },
    { x: 145, type: 'enemy-soldier', count: 1, formation: 'line' },
  ],
