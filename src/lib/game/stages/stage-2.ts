...
export const stage2: StageConfig = {
  ...
  spawns: [
    { x: 55,  type: 'enemy-soldier', count: 2, formation: 'line' },
    { x: 75,  type: 'enemy-turret',  count: 1, formation: 'line' },
    { x: 95,  type: 'enemy-drone',   count: 1, formation: 'line', altitude: 8 },
    { x: 110, type: 'enemy-turret',  count: 1, formation: 'line' },
    { x: 125, type: 'enemy-soldier', count: 2, formation: 'spread' },
    { x: 150, type: 'enemy-drone',   count: 2, formation: 'staggered' },
    { x: 165, type: 'enemy-turret',  count: 1, formation: 'line' },
    { x: 175, type: 'enemy-soldier', count: 1, formation: 'line' },
    { x: 200, type: 'enemy-soldier', count: 2, formation: 'spread' },
  ],
